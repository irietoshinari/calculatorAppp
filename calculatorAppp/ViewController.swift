...
//                    switch calculateStatus {
//                    case .plus:
//                        rezultString = String(firstNum + secondNum)
//                    case .minus:
//                        rezultString = String(firstNum - secondNum)
//                    case .multiplication:
//                        rezultString = String(firstNum * secondNum)
...
//
//
//                    if let result = rezultString, result.hasSuffix(".0"){
//                        rezultString = result.replacingOccurrences(of: ".0", with: "")
//                    }
//
//                    numberLabel.text = rezultString
//                    firstNumber = ""
//                    secondNumber = ""
//
//                    firstNumber += rezultString ?? ""
//                    calculateStatus = .none
//
//                case "C":
//                    clear()
